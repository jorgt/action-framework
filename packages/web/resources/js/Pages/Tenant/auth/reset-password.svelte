...
<div class="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-accents-900">Reset your password</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <form class="space-y-6" on:submit|preventDefault={submit}>
      ...
      <div>
        <label for="password" class="block text-sm font-medium leading-6 text-accents-900"> New Password </label>
        <div class="mt-2">
      ...
      <div>
        <label for="password_confirmation" class="block text-sm font-medium leading-6 text-accents-900"> Confirm New Password </label>
        <div class="mt-2">
      ...
      <div>
        <button type="submit" class="flex w-full justify-center rounded-md bg-main-600 px-3 py-2 text-sm font-semibold text-white shadow shadow-accents-200-sm hover:bg-main-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-main-600">Reset Password</button>
      </div>
    </form>
  </div>
</div>
