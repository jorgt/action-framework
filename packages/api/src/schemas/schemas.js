...
export const queue = {
  ...
  properties: {
    ...
    action: {
      ...
      required: [
        'actions', 'entity_id', 'sequence_id', 'sequence_code', 'action_matrix_id', 
        'action_matrix_code', 'current_status_code', 'sequence_description', 
        'current_status_description', 'status_on_sequence_failure_id', 
        'status_on_sequence_success_id', 'status_on_sequence_failure_code', 
        'status_on_sequence_success_code', 'status_on_sequence_failure_description', 
  ...
  required: ['id', 'entity_id', 'entity_type', 'action', 'payload', 'result', 'created_at', 'status', 'retries', 'start'],
};
  ...
  properties: {
    ...
    sequences: {
      ...
      items: {
        ...
        required: ['sequence_id', 'sequence_code', 'sequence_description', 'status_on_sequence_success_code', 'status_on_sequence_failure_code'],
      },
    },
  },
};
...
export const webhooks = {
  ...
  properties: {
    ...
    parameters: { type: 'array', items: { type: 'object', properties: { name: { type: 'string' }, value: { type: 'string' } } } },
    url: { type: 'string' },
    method: { type: 'string' },
